  ...
  CCE.router.register('#/commands', {
    ...
    mount: function (root) {
      ...
      root.innerHTML =
        ...
        '<div class="doc-resizer" id="commands-resizer" role="separator" aria-label="Resize commands list" tabindex="0"></div>' +
      ...
      if (CCE.app.initResizable) {
        CCE.app.initResizable(root.querySelector('#commands-resizer'), listEl, { min: 220, max: 460, key: 'commands-list-width' });
      }
